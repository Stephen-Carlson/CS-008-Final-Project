...
<article class = "AboutUs">
    ...
    <figure>
        <img src="../images/band.png" alt="A picture of the band">  <!-- Insert picture of band btw -->
...
<article class ="AboutMemelord">
    <h6>Meet Memelord</h6>
    <figure>
        <img src="../images/singer.png" alt="A picture of Memelord">  <!-- Insert picture of meme btw -->
